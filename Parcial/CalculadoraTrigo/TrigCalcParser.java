...
public class TrigCalcParser extends Parser {
	...
	public static final int
		RULE_prog = 0, RULE_expr = 1, RULE_function = 2, RULE_angle = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "expr", "function", "angle"
		};
	}
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TrigCalcListener ) ((TrigCalcListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TrigCalcListener ) ((TrigCalcListener)listener).exitProg(this);
		}
	}
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TrigCalcListener ) ((TrigCalcListener)listener).enterFunction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TrigCalcListener ) ((TrigCalcListener)listener).exitFunction(this);
		}
	}
	...
	public static class AngleContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TrigCalcListener ) ((TrigCalcListener)listener).enterAngle(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TrigCalcListener ) ((TrigCalcListener)listener).exitAngle(this);
		}
	}
